...
assert.match(html,/<title>Warden<\/title>/);
assert.match(html,/data-instance-launcher/);
assert.match(html,/data-product="warden"/);
...
assert.ok(js.includes("DEFAULT_LOCAL_URL='http://localhost:7332/'"));
...
console.log('Warden instance launcher contracts passed');
